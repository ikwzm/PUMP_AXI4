...
proc init_gui { IPINST } {
	...
	set O_QUEUE_SIZE    [ ipgui::add_param $IPINST -parent $tabgroup3 -name O_QUEUE_SIZE]
...
proc update_PARAM_VALUE.O_QUEUE_SIZE { PARAM_VALUE.O_QUEUE_SIZE } {
	# Procedure called to update O_QUEUE_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.O_QUEUE_SIZE { PARAM_VALUE.O_QUEUE_SIZE } {
	# Procedure called to validate O_QUEUE_SIZE
	return true
}
...
proc update_PARAM_VALUE.I_QUEUE_SIZE { PARAM_VALUE.I_QUEUE_SIZE } {
	# Procedure called to update I_QUEUE_SIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.I_QUEUE_SIZE { PARAM_VALUE.I_QUEUE_SIZE } {
	# Procedure called to validate I_QUEUE_SIZE
	return true
}
...
proc update_MODELPARAM_VALUE.I_QUEUE_SIZE { MODELPARAM_VALUE.I_QUEUE_SIZE PARAM_VALUE.I_QUEUE_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.I_QUEUE_SIZE}] ${MODELPARAM_VALUE.I_QUEUE_SIZE}
}
...
proc update_MODELPARAM_VALUE.O_QUEUE_SIZE { MODELPARAM_VALUE.O_QUEUE_SIZE PARAM_VALUE.O_QUEUE_SIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.O_QUEUE_SIZE}] ${MODELPARAM_VALUE.O_QUEUE_SIZE}
}
